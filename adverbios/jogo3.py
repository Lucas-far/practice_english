...
from adverbios.bdd_adverbios import adverb_others, adverb_others_pt_br
    ...
    try:
        ...
        def create_word():
            ...
            while len(five_words) < 5:
                five_words.add(choice(adverb_others))
        ...
        greetings = welcome('treino de advérbios (outros)', prefix=3, prefix2=7)
