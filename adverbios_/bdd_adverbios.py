...
adverb_others_pt_br = [
    ...
    'muito', 'ainda assim/mesmo assim/porém/todavia', 'apesar disso', 'agora/já', 'fora',
    'outrora/uma vez', 'de outro modo', 'fora', 'através/sobre', 'talvez', 'bastante/muito',
    'assim/tão/então/portanto', 'em breve/logo/rapidamente', 'ainda',
