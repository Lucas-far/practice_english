...
while True:
    ...
    adverb_chosen_key = choice(adv_frequency_keys)
    # print(f'{adverb_chosen_key = }')

    ""  # adverb_chosen_values = ('clearly', 'claramente')
    adverb_chosen_values = adv_frequency[adverb_chosen_key]
    ...
    def create_adverbs():
        ...
        while len(box_words) < 5:
            ...
            new_adverb_key = choice(adv_frequency_keys)
            # print(f'{new_adverb_key = }')
            new_adverb_values = adv_frequency[new_adverb_key]
