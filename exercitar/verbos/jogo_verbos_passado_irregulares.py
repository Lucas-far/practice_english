...
from gramatica.verbos.passado import past_irregular, past_irregular_keys
...
while True:
    ...
    past_chosen_key = choice(past_irregular_keys)
    # print(f'{past_chosen_key = }')

    ""  # past_chosen_values = ('understood', 'compreendi/entendi')
    past_chosen_values = past_irregular[past_chosen_key]
    ...
    def create_verbs_past():
        ...
        while len(box_words) < 5:
            ...
            new_past_key = choice(past_irregular_keys)
            # print(f'{new_past_key = }')
            new_past_values = past_irregular[new_past_key]
