...
pst_uniques = {
    'to be': ('was', 'were', 'era/estava', 'eram/estãvam'),
    'to have': ('had', 'possui/tinha', 'possuiam/tinham'),
    'to do': ('did', 'fiz', 'fizeram'),
}
...
if __name__ == '__main__':
    ...
    print(bricks)
    print(f"{len(past) = }")
    print(f"{len(past_keys) = }")
    print(f"{len(past_keys_index0) = }")
    print(f"{len(past_keys_index1) = }")

    print(f"{len(past_irregular) = }")
    print(f"{len(past_irregular_keys) = }")
    print(f"{len(past_irregular_keys_index0) = }")
    print(f"{len(past_irregular_keys_index1) = }")

    print(bricks)
    print(f"{past = }")
    print(f"{past_keys = }")
    print(f"{past_keys_index0 = }")
    print(f"{past_keys_index1 = }")

    print(bricks)
    print(f"{past_irregular = }")
    print(f"{past_irregular_keys = }")
    print(f"{past_irregular_keys_index0 = }")
    print(f"{past_irregular_keys_index1 = }")
