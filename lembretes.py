...
does_not_short_need_to_have = "doesn't need to have"
do_not_short_need_to_have = "don't need to have"

has_infinitive = 'has to know'
have_infinitive = 'have to know'
does_not_have_infinitive = 'does not have to know'
do_not_have_infinitive = 'do not have to know'
does_not_short_have_infinitive = "doesn't have to know"
do_not_short_have_infinitive = "don't have to know"
