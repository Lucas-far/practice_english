...
while True:
    ...
    try:
        ...
        five_words = list(create_set(empty_set, 5, pronouns_to_be_simple, True))  # function create_set()
        five_indexes = [pronouns_to_be_simple.index(word) for word in five_words]
        five_translations = [pronouns_to_be_simple_pt_br[index] for index in five_indexes]
