...
have_past_l_pt_br = ['tinha (todos pronomes)', 'não tinha (todos pronomes)', 'não tinha (todos pronomes)']

have_present_l = ['has', 'does not have', "doesn't have", 'have', 'do not have', "don't have"]

have_present_l_pt_br = [
    'tem (3a pessoa)', 'não tem (3a pessoa)', 'não tem (3a pessoa)',
    'tem (1a/2a pessoa)', 'não tem (1a/2a pessoa)', 'não tem (1a/2a pessoa)'
]

have_future_l = ['will have', 'will not have', "won't have"]

have_future_l_pt_br = ['terei (todos pronomes)', 'não terei (todos pronomes)', 'não terei (todos pronomes)']
"----------------------------------------------------------------------------------------------------------------------"
