...
past_pt_br = [
    ...
    'levei / peguei / tomei', 'vi', 'cheguei / vim', 'pretendia / queria', 'olhei / vi', 'usei', 'achei / encontrei',
    'dei', 'contei / disse', 'funcionei / trabalhei', 'chamei / telefonei', 'experimentei / tentei', 'pedi / perguntei',
    'necessitei / precisei',

    'senti', 'me tornei', 'abandonei / deixei / sai', 'coloquei / pus', 'quis dizer / signifiquei',
    'continuei / guardei / mantive', 'deixei / permiti', 'começei / iniciei', 'pareci', 'ajudei / auxiliei',
    'conversei / falei', 'transformei / virei', 'começei / iniciei', 'apresentei / mostrei', 'escutei / ouvi',
    'joguei / toquei', 'corri', 'movi / mexi', 'gostei', 'morei / vivi',

    'acreditei / cri', 'mantive / segurei', 'trouxe', 'aconteci / ocorri', 'escrevi', 'forneci / proporcionei',
    'sentei', 'fiquei / suportei', 'perdi', 'paguei', 'conheci / encontrei / reuni', 'inclui', 'continuei',
    ...
    'impedi / parei', 'criei', 'conversei / falei', 'li', 'autorizei / permiti', 'acrescentei / adicionei',
    'gastei / passei', 'aumentei / cresci', 'abri', 'andei / caminhei', 'ganhei / venci', 'ofereci / propus',
    'lembrei / recordei', 'adorei / amei', 'considerei', 'apareci', 'comprei', 'esperei', 'servi', 'faleci / morri',

    'enviei / mandei', 'esperei', 'construi', 'fiquei / permaneci', 'cai', 'cortei', 'alcançei / atingi / cheguei a',
    'matei', 'fiquei / permaneci', 'sugeri', 'aumentei / criei alguém,algo / levantei', 'passei',
    'vendi', 'exigi / necessitei', 'relatei / reportei', 'decidi', 'puxei', 'rompi / quebrei',
    'adquiri / comprei / obtive', 'percebi / realizei',

    'administrei / geri', 'cresci / desenvolvi', 'confiei', 'imaginei', 'pisei', 'arrependi / lamentei', 'manipulei',
    'sonhei', 'debati / discuti', 'bebi', 'comi', 'pulei / saltei', 'repeti', 'adivinhei / supus', 'selecionei',
    'cliquei'
]
