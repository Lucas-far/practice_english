...
while True:
    ...
    try:
        ...
        five_words = list(create_set(empty_set, 5, past, True))  # function create_set()
        five_indexes = [past.index(word) for word in five_words]
        five_translations = [past_pt_br[index] for index in five_indexes]
        ...
        print(hello := greetings('treino de verbos no passado', index1=3))
