...
while True:
    ...
    try:
        ...
        five_words = list(create_set(empty_set, 5, present_1st_2nd_persons, True))  # function create_set()
        five_indexes = [present_1st_2nd_persons.index(word) for word in five_words]
        five_translations = [present_1st_2nd_persons_pt_br[index] for index in five_indexes]
        ...
        print(hello := greetings('treino de verbos no presente (1a, 2a PESSOA)', index1=3))
