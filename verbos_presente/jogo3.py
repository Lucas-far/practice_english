...
while True:
    ...
    try:
        ...
        five_words = list(create_set(empty_set, 5, present_3rd_person, True))  # function create_set()
        five_indexes = [present_3rd_person.index(word) for word in five_words]
        five_translations = [present_3rd_person_pt_br[index] for index in five_indexes]
        ...
        print(hello := greetings('treino de verbos no presente (3a pessoa)', index1=3))
